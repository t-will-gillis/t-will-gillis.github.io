...
<figure>
  <img src="../assets/img/site_images/cysky/file_carving_5.png" alt="" title="Use binwalk to analyze `green_file` and extract hidden files" style="max-width:67%; margin:auto" >
...
<figure>
  <img src="../assets/img/site_images/cysky/file_carving_8.png" alt="" title="Contents of `_green_file.png.extracted`" style="max-width:67%; margin:auto" >
...
<figure>
  <img src="../assets/img/site_images/cysky/magic_bytes_22.png" alt="" title="Use HexEdIt on file" style="max-width:50%; margin:auto" >
  <figcaption style="font: italic small sans-serif; text-align:center">Use HexEdIt on file: top</figcaption>
</figure> 
<figure>
  <img src="../assets/img/site_images/cysky/magic_bytes_25.png" alt="" title="Use HexEdIt on file" style="max-width:50%; margin:auto" >
...
<figure>
  <img src="../assets/img/site_images/cysky/magic_bytes_35.png" alt="" title="Editing the magic bytes for a PNG signature" style="max-width:67%; margin:auto" >
...
<figure>
  <img src="../assets/img/site_images/cysky/the_book_10.png" alt="" title="Use volatility3 to analyze `memdump.mem`" style="max-width:67%; margin:auto" >
  <figcaption style="font: italic small sans-serif; text-align:center">Use volatility3 to analyze `memdump.mem`</figcaption>
</figure> 

<figure>
  <img src="../assets/img/site_images/cysky/the_book_12.png" alt="" title="Use volatility3 to analyze `memdump.mem` cont." style="max-width:67%; margin:auto" >
  <figcaption style="font: italic small sans-serif; text-align:center">Use volatility3 to analyze `memdump.mem` cont.</figcaption>
</figure> 

<figure>
  <img src="../assets/img/site_images/cysky/the_book_14.png" alt="" title="Use volatility3 to analyze `memdump.mem` final" style="max-width:67%; margin:auto" >
...
<figure>
  <img src="../assets/img/site_images/cysky/the_book_20.png" alt="" title="File of interest in FileDump` final" style="max-width:67%; margin:auto" >
...
<figure>
  <img src="../assets/img/site_images/cysky/the_book_40.png" alt="" title="Use volatility3 to analyze `memdump.mem`" style="max-width:67%; margin:auto" >
  </figure>
<figure>
  <img src="../assets/img/site_images/cysky/the_book_41.png" alt="" title="Missing module in volatility3's `HashDump`" style="max-width:67%; margin:auto" >
...
<figure>
  <img src="../assets/img/site_images/cysky/the_book_50.png" alt="" title="After creating venv and installing pycryptodome" style="max-width:67%; margin:auto" >
...
<figure>
  <img src="../assets/img/site_images/cysky/the_book_55.png" alt="" title="Use crackstation.net to crack the hash" style="max-width:67%; margin:auto" >
