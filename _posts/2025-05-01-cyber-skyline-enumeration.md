---
layout: post
title: 'CySky: Enumeration'
date: 2025-05-01 19:07 -0700
description: CySky Notes Enumeration & Exploitation
image:
  path: ../assets/img/site_images/cysky/cs_0r2.png
  alt: CySky Enumeration
category: [CySky]
tags: [cysky, notes, cybersecurity, enumeration, exploitation, cyberchef, uncompyle, gdb, ghidra]
---
...
<figure style="text-align:center">
  <img src="../assets/img/site_images/cysky/enum_py2_1.png" alt="" title="Uncompiled PYTHON2.pyc" width=500 >
...
<figure style="text-align:center">
  <img src="../assets/img/site_images/cysky/enum_py2_2.png" alt="" title="Using CyberChef on Caesar Cipher" width=500 >
...
<figure style="text-align:center">
  <img src="../assets/img/site_images/cysky/enum_py3_1.png" alt="" title="Uncompiled PYTHON3.pyc" width=500 >
...
<figure style="text-align:center">
  <img src="../assets/img/site_images/cysky/enum_bin1_1.png" alt="" title="Run ghidra" width=500 >
...
<figure>
  <img src="../assets/img/site_images/cysky/enum_bin1_5.png" alt="" title="Source code with main()" style="max-width:80%; margin:auto" >
...
<figure>
  <img src="../assets/img/site_images/cysky/enum_bin1_10.png" alt="" title="Source code with fg()" style="max-width:80%; margin:auto" >
...
<figure style="text-align:center">
  <img src="../assets/img/site_images/cysky/enum_bin1_18.png" alt="" title="Value of `local_20`" style="max-width:80%; margin:auto" >
...
<figure>
  <img src="../assets/img/site_images/cysky/enum_bin2_5.png" alt="" title="Run `info functions` in gdb" style="max-width:80%; margin:auto" >
...
<figure>
  <img src="../assets/img/site_images/cysky/enum_bin2_10.png" alt="" title="Value of `local_15` in getflagbytid()" style="max-width:80%; margin:auto" >
...
<figure>
  <img src="../assets/img/site_images/cysky/enum_bin2_20.png" alt="" title="Last four chars in getflagbytid()" style="max-width:80%; margin:auto" >
