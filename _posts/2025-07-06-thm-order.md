...
image:
  path: ../assets/img/site_images/thm-order/order_00.png
...
---
![Desktop View](../assets/img/site_images/thm-order/order_0.png){: width="972" height="589" }
...
<figure>
  <img src="../assets/img/site_images/thm-order/order_10.png" alt="" title="Initial Description of XOR Cipher" style="max-width:75%; margin:auto; box-shadow: 4px 4px 8px rgba(125, 125, 125, 0.5);">
...
<figure style="text-align:center">
  <img src="../assets/img/site_images/thm-order/order_20.png" alt="" title="Using CyberChef to Decipher" style="max-width:75%; margin:auto; box-shadow: 4px 4px 8px rgba(192,192,192,0.5);">
...
<figure>
  <img src="../assets/img/site_images/thm-order/order_30.png" alt="" title="Final Message Deciphered" style="max-width:75%; margin:auto; box-shadow: 4px 4px 8px rgba(192,192,192,0.5);">
